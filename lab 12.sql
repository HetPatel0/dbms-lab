...
select PersonID, Person.PersonName, Person.Salary, Person.JoiningDate, Person.City, Dept.DepartmentName
from Person join Dept
on Person.DepartmentID = Dept.DepartmentID
...
select sum(Person.Salary)  as total_salary, avg(Person.Salary)  as avg_salary, max(Person.Salary)  as max_salary, min(Person.Salary) as min_salary, Person.City
from Person join Dept
on Person.DepartmentID = Dept.DepartmentID
